...
// wiki sections. Each value is the enriched markdown body that the
// deterministic `organize` step persists verbatim.
...
const composeStep = {
  ...
  prompt: [
    ...
    '',
    'Compose FOUR enriched markdown sections for the wiki by COMBINING',
    ...
    '',
    '1. profileSummary (markdown):',
    '   1-2 paragraph narrative bio. Open with name + headline + location.',
    '   Weave in their current role, what they offer, and what they are',
    '   looking for. End with a "## Links" subsection listing every link',
    '   they shared (LinkedIn, Website, GitHub, Twitter/X, Telegram) as',
    '   bullet items in the form `- **LinkedIn:** <url>`. Skip links the',
    '   user marked as null. NO "## Profile" heading — the section IS',
    '   the profile.',
    '',
    '2. workExperience (markdown):',
    '   Narrative covering their trajectory. Use research findings to',
    '   expand each role/company with verified facts (founding year,',
    '   sector, scale, notable projects). Group by company/role with',
    '   "### " subheadings when there are multiple. Be specific, not',
    '   generic; do not invent facts the research did not confirm.',
    '',
    '3. productsServices (markdown):',
    ...
    '   Use bullets if listing multiple offerings; short paragraphs',
    '   otherwise. Each item should be verifiable (mention the product',
    '   name, link if known, sector). If research surfaces nothing',
    '   beyond what the user said, just enrich the wording.',
    '',
    '4. events (markdown):',
    '   Events the member organized, attended as speaker, or is publicly',
    '   associated with — drawn from research. Use bullets per event with',
    '   year, role (organizer / speaker / participant) and name. If the',
    '   research surfaced no events, write exactly: "Sin eventos públicos',
